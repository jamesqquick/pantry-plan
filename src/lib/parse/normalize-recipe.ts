...
/**
 * Split a single string that contains multiple numbered steps
 * into an array of step strings with number bullets stripped.
 */
...
/** Normalize instructions: support strings, HowToStep objects, or ItemList with itemListElement. */
