...
INSERT INTO "new_RecipeIngredient" ("baseRecipeIngredientId", "changeType", "conversionConfidence", "conversionNotes", "conversionSource", "createdAt", "id", "ingredientId", "nameNormalized", "normalizedKey", "originalLine", "originalQuantity", "originalUnit", "parseConfidence", "parseNotes", "quantity", "quantityFraction", "quantityWhole", "rawQuantityText", "rawText", "recipeId", "sortOrder", "unit", "updatedAt", "weightGrams") SELECT "baseRecipeIngredientId", "changeType", "conversionConfidence", "conversionNotes", "conversionSource", "createdAt", "id", "ingredientId", "nameNormalized", "normalizedKey", "originalLine", "originalQuantity", "originalUnit", "parseConfidence", "parseNotes", "quantity", "quantityFraction", "quantityWhole", "rawQuantityText", "rawText", "recipeId", "sortOrder", "unit", "updatedAt", "weightGrams" FROM "RecipeIngredient";
...
-- Backfill: lineText = originalLine, importText = rawText or originalLine
UPDATE "RecipeIngredient" SET "lineText" = "originalLine", "importText" = COALESCE("rawText", "originalLine") WHERE "lineText" IS NULL;
